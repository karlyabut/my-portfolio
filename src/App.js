    ...
    return (
      <Fragment>
        <div style={{ height: "100%" }}>
          <Navbar
            drawerClickHandler={this.drawerToggleClickEvet}
            scrollAbout={this.scrollToAbout}
            scrollProject={this.scrollToProject}
          />
          <SideDrawer
        ...
        <main className="wrapper">
          ...
          <section ref={this.scrollAbout} className="section about">
            <div className="aboutMe">
              <h1>
                Hi! I'm Karl, a Full Stack Developer based in Toronto, Canada.
                Welcome to my page!
              </h1>
              <p className="descP">
                I've been interested in technology ever since high-school, Grade
              ...
              <p className="descP">
                ...
                great challenge that fully enabled my passion towards being a
                developer!
              </p>
            </div>
          </section>
            ...
            <div className="projectsContainer">
              <div className="projectContainer">
                <div className="descContainer">
                  ...
                  <p>
                    A combination of broken telephone and pictionary party game.
                  </p>
